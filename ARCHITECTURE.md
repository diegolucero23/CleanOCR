...
| `MODEL_NAME` | `gemini-2.5-flash-lite` | Active model (standard tier). Swap to `PRO_MODEL_NAME` value for pro tier. |
| `PRO_MODEL_NAME` | `gemini-3.1-flash-lite` | Pro-tier model identifier. |
| `FALLBACK_MODEL_NAME` | `gemini-2.5-flash-lite` | Auto-fallback if the active model is unavailable/deprecated. |
